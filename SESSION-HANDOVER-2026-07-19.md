...
- **public property detail (`/properties/[code]`) — น่าจะยังไม่ได้ลุคพรีเมียมชุดใหม่** (commit ล่าสุด = ก่อน redesign v2: P6 editorial/serif ที่ revert แล้ว) → candidate ถัดไป: จัดให้เข้าชุด home/listing (price-first · radius A · Zillow) เสนอ widget + ถามก่อน
