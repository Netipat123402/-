...
- **📊 สถานะ: STAGE1 ~78%** — ✅ P0·P1·**P2 Home 9/9**·**P3 /property list**·**P4 detail** · ✅ **P5 /agent** (header + 3 การ์ด monogram + reuse About/Fresh · `c63770c` · ⚠️ monogram แทนรูปหน้า—ไม่มี asset) · ⬜ **P6 = ถัดไป** (About us หรือ Blog หรือ Contact) · P7–P11
- **🧩 reusable sections (แยกแล้ว):** `AboutBenefits` · `FreshSection`(viewAll prop) · `FreshListings`(client filter) · `icons.tsx`(ITarget/ICheckSm/IStar) — Home+Agents ใช้ร่วม · ⏳ ค้าง P4: Video section, more-in-location กรองย่าน
