...
- **📊 สถานะ: STAGE1 ~60%** — ✅ **P0** · ✅ **P1 จบ** (Nav 3จอ + Footer/CTA) · ✅ **P2 Home จบ 9/9** (hero·Featured bento·About collage·Cities·Steps timeline·Fresh+filter·Testimonials marquee·Stats band·Insights — verify 3 จอทุก section) · ⬜ **P3 = ถัดไป** (หน้า /property list pixel-clone) · P4–P11
