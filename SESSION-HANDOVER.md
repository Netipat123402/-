...
- ✅ **ลีด list = จบ** (เบอร์ใต้ชื่อ + เข้ามาเมื่อ + เฉลี่ยช่องไฟ · verify 4 จอ)
- ⏳ **ยังไม่ทำ (รอสั่งทีละหน้า):** นัดหมาย list (นัดกับ → 2 บรรทัด ชื่อ+วันเวลา) · ยืนยัน/จูน เจ้าของ·ลูกค้า·ทรัพย์·สัญญา list ทีละหน้า · ชุดคอลัมน์ที่อยากเพิ่ม (เจ้าของ=มูลค่าพอร์ต · ลูกค้า=ค่าเช่าปัจจุบัน) = **ติด R2 backend**
