...
- **📊 สถานะ: STAGE1 ~65%** — ✅ **P0** · ✅ **P1** (Nav+Footer) · ✅ **P2 Home จบ 9/9** · ✅ **P3 /property list** (header Fresh + sidebar filter Type/Category/Location + grid 2-col rich card · filter ทำงานจริง verify แล้ว · commit `8a34be8`) · ⬜ **P4 = ถัดไป** (property detail `/property/[slug]`) · P5–P11
