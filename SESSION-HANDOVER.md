...
- **📊 สถานะ: STAGE1 ~96%** — ✅ P0–P8 · ✅ **P9 Blog** (list 9 การ์ด + detail breadcrumb/hero/body + related · `9212b71` · ArticleCard reuse Home Insights) · ⬜ **P10 = ถัดไป** (Motion polish — Framer-style appear/hover ทั้งเว็บ) · P11 QA รวบ 3 จอทุกหน้า → จบ STAGE1 พร้อม STAGE2 (Notify/ไทย)
