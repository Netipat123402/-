...
- **📊 สถานะ: STAGE1 ~72%** — ✅ **P0** · ✅ **P1** (Nav+Footer) · ✅ **P2 Home 9/9** · ✅ **P3 /property list** (`8a34be8`) · ✅ **P4 property detail `/property/[slug]`** (header+hero+2col[desc/features/details/utility/location/gallery + sidebar contact/schedule form/more]+related · `48e6dad` · ⏳ ค้าง: Video section, more-in-location ยังไม่กรองย่าน) · ⬜ **P5 = ถัดไป** (Agents หรือ About/Contact — เลือกตามลำดับ) · P6–P11
