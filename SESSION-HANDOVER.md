...
- **📊 สถานะ: STAGE1 ~92%** — ✅ P0–P7 · ✅ **P8 /add-property** (Submit property · ฟอร์มยาว centered ครบทุกกลุ่ม static · `c0d096e`) · ⬜ **P9 = ถัดไป** (Blog list + detail) · P10 Motion polish · P11 QA รวบ 3 จอ
