...
- **📊 สถานะ: STAGE1 ~97%** — ✅ P0–P9 · ✅ **P10 Motion** (scroll reveal ทั้งเว็บ · `ScrollReveal` utility กลาง auto-detect target ไม่แก้ markup · reduced-motion safe · `5a1afa5`) · ⬜ **P11 = ถัดไป (สุดท้าย)** QA รวบทั้งเว็บ 3 จอทุกหน้า → จบ STAGE1 พร้อม STAGE2 (สลับ Notify/ไทย)
