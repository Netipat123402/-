...
- **🔵 ถัดไป · เฟส 3 · หน้าอ้างอิงเซล** (ทรัพย์+เจ้าของ ให้ "อ่านอย่างเดียว" ชัดด้วยดีไซน์ catalog · CTA=ขอเพิ่มทรัพย์ ไม่ใช่ เพิ่มทรัพย์) · **เฟส 4 · surface เจ้าของ** (คิวอนุมัติ+widget กันโกง/sensitive alerts)
