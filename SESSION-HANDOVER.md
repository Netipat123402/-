...
- **📊 สถานะ: STAGE1 ~30%** — ✅ **P0** (harness+capture Home reference@3+measure · Playwright loop พิสูจน์แล้ว) · ✅ **P1 จบ** (Nav desktop **pixel-match** + tablet/mobile collapse hamburger+open menu verified · **Footer + CTA pixel-clone** วัด→สร้าง→เทียบ 3 จอผ่าน) · ⬜ **P2 Home(8 sec) = ถัดไป** · P3–P11
- **commit web-v2:** `ef77845`(scaffold) · `c51343a`(fonts+assets+nav/footer **v0**) · `a0a2745`+`a9ad501`(home **v0**) · `a565192`(property list **v0**) · `0147282`(P0 Playwright harness) · `05cb4ab`(P1 Nav pixel-accurate) · **`6b5622b`(P1 Footer+CTA pixel-clone)** · ⚠️ **v0 = ดราฟต์ไทย/หยาบ กำลังถูกรื้อ pixel-accurate อังกฤษ ทีละหน้า** (Nav+Footer รื้อแล้ว · home/property ยังเป็น v0)
