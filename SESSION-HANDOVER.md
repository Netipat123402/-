...
- **📊 สถานะ: STAGE1 ~84%** — ✅ P0·P1·**P2 Home**·**P3 list**·**P4 detail**·**P5 /agent** · ✅ **P6 /about** (header+collage+stats(light)+timeline+steps-variant+team+testimonials+FAQ accordion · `56b3b44` · FAQ verify คลิกได้) · ⬜ **P7 = ถัดไป** (Blog หรือ Contact) · P8–P11
- **🧩 reusable components (แยกแล้ว):** `AboutBenefits` · `FreshSection`(viewAll) · `FreshListings`(client) · `Testimonials` · `StatsBand`(variant dark/light) · `FaqAccordion`(client) · `icons.tsx` — reuse Home/Agents/About · ⏳ ค้าง P4: Video section, more-in-location กรองย่าน
