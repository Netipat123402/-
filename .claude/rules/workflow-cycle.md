...
## 0) ⭐⭐⭐ กฎการทำงานร่วม (Operating Agreement — owner ย้ำ · ยึดเหนือความเร็ว)
> วิธี "คุยกัน" บนงานทุกชิ้น โดยเฉพาะงานใหญ่/หลายเฟส. **สมบูรณ์ + รองรับอนาคต สำคัญกว่าเร็ว.**
1. **คุยด้วยเหตุผลก่อน ไม่ทำเลย (reasoning-first)** — วิเคราะห์ + เสนอ + ให้เหตุผลระดับโลก + รูปเทียบ ก่อนลงมือทุกครั้ง
2. **ทีละขั้น หยุดรอเคาะทุกครั้ง** — ทำเสร็จเป็นอย่างๆ หยุด รายงาน รอเคาะ · ห้ามรวบหลายขั้นเอง
3. **เสร็จแล้วเช็คงานซ้ำตาม CYCLE** — self-review หลังจบทุกชิ้น (ไม่เชื่อว่าเสร็จทันที · verify จริง)
4. **แจ้งเชิงรุกเสมอ** — เจอตำหนิ / ข้อสงสัย / ความเสี่ยงอนาคต **แม้ในงานที่ทำเสร็จแล้ว หรือแผนที่วางดีแล้ว** → แจ้ง + เสนอแนวทางใหม่ทันที
5. **บอกความคืบหน้าทุกข้อความ** — เขียนเฟส/งานที่เหลือเสมอ (เช่น "Phase 1/6" หรือ "เหลือ /5")
6. **ระดับโลก · สมบูรณ์ · รองรับอนาคต** — ไม่เอาทางลัด · เน้นครบถ้วนเผื่อโต · ออกแบบให้สเกลได้
