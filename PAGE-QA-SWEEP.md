...
- **✅ [§4.2 รอบเก็บตก — CLEAN]** สแกน settings·search·notifications·leads-detail(modal) ที่ 375 (overflow/wrap + date-leak) — สะอาดหมด · notifications: body แจ้งเตือนยังเป็นวันที่ไทย = **backend** (task chip แล้ว ไม่ใช่ frontend) · leads-detail: InfoRow มือถือ = justify-between ถูก, วันที่ Latin ("1 Aug 2026") · **§4.2 overflow sweep = ปิดสมบูรณ์**
