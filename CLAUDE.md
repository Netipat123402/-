...
7. **กฎการทำงานร่วม (Operating Agreement)** — คุยด้วยเหตุผลก่อนทำ · ทีละขั้นหยุดรอเคาะ · เสร็จแล้วเช็คซ้ำ · แจ้งความเสี่ยงเชิงรุก **แม้แผนดี/ทำเสร็จแล้ว** · บอกเฟสที่เหลือทุกข้อความ · ระดับโลกเผื่ออนาคต → `.claude/rules/workflow-cycle.md §0`
